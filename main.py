...
TOKEN = '7700237681:AAF-8YhvMRod0QGiHmg9B0RDd6gHh8SFSfk'
...
def handle_message(message):
    ...
    else:bot.send_message(message.chat.id, "Извините, я не понимаю этот запрос. Выберите один из доступных вариантов.")
